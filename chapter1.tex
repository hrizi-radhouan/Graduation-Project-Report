...
\vspace{66mm}
	\subsection{Customers}
		...
		\captionsource{MASS Analytics’ customers}{https://www.mass-analytics.com/values/}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\captionsource{Software Development Life Cycle iterative}{ https://www.tutorialspoint.com/}
	...
	The developer writes a little test code and then implements the business, in the traditional method, the test comes from the code, but in TDD the business code is submissive to tests then it is corrected until the tests are validated. 
		...
		\captionsource{TDD Global Lifecycle}{https://commons.wikimedia.org/wiki/}
	\end{figure}   
